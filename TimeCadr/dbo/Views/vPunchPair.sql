...
AS
SELECT        PIn.Type AS TypeIn, dbo.PunchPair.Start, POut.Type AS TypeOut, dbo.PunchPair.Stop
FROM            dbo.vPunch AS PIn INNER JOIN
                         dbo.PunchPair ON PIn.Time = dbo.PunchPair.Start INNER JOIN
                         dbo.vPunch AS POut ON dbo.PunchPair.Stop = POut.Time
GO
