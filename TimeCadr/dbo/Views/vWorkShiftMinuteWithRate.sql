...
AS
SELECT        dbo.WorkShiftMinute.WorkShiftStart, dbo.RateCodeByRange.RateCodeId, COUNT(dbo.WorkShiftMinute.Minute) AS Minutes, MAX(dbo.WorkShiftMinute.Hour) 
                         AS Hours
FROM            dbo.WorkShiftMinute INNER JOIN
                         dbo.RateCodeByRange ON dbo.WorkShiftMinute.Hour BETWEEN dbo.RateCodeByRange.HourStart AND dbo.RateCodeByRange.HourStop
GROUP BY dbo.RateCodeByRange.RateCodeId, dbo.WorkShiftMinute.WorkShiftStart
GO
