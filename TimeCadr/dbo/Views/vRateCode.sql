...
AS
SELECT        dbo.RateCode.Id, dbo.RateCode.Name, dbo.RateCode.Rate, dbo.RateCodeType.Name AS Type, dbo.RateCode.TypeId
FROM            dbo.RateCode INNER JOIN
                         dbo.RateCodeType ON dbo.RateCode.TypeId = dbo.RateCodeType.Id
GO
