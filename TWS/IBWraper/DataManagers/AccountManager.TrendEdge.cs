  ...
  public partial class AccountManager {
    ...
    void WireTrendEdges() {
      var parameter = (
        ...
        .Retry()
        .Do(p => TraceIf(_WireTrendEdgesTest, $"EdgeParams {new { p.param.contract,edge= p.tl.level.Round(2), current = p.param.currentOrders.Flatter("") }}"))
