...
namespace Microsoft.Research.DynamicDataDisplay.Common
{
	...
	{
		IndependentArrangePanel hostPanel;
		...
		{
			hostPanel = (IndependentArrangePanel)visualParent;
		...
		public override int Add(UIElement element)
		{
			...
			{
				hostPanel.OnChildAdded(element);
			}
			return visualChildren.Add(element);
		}
