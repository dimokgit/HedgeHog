...
SELECT        TS.Pair, TS.SessionId, S.SuperUid AS SuperSessionUid, TS.TimeStamp, TS.Count, TS.GrossPL, TS.Days,S.Profitability, ISNULL(S.MaximumLot, TS.Lot * 1.4) AS Lot, 
                         ...
                         DistanceDaysBack.Value AS DistanceDaysBack,
                         ...
                         TrailingDistanceFunction.Value AS TrailingDistanceFunction,
...
OUTER APPLY fGetSessionValue(TS.SessionInfo, 'DistanceDaysBack') AS DistanceDaysBack
