...
namespace Microsoft.Research.DynamicDataDisplay.Charts
{
	...
	public class DataFollowChart : ViewportRectPanel, INotifyPropertyChanged
	{
		/// <summary>
		...
		public DataFollowChart()
		{
			...
			SetViewportX(marker, 0);
			SetViewportY(marker, 0);
			Children.Add(marker);
		}
		...
		private void UpdateUIRepresentation()
		{
			...
			else
			{
				...
				if (!searchResult.IsEmpty)
				{
					...
					SetViewportX(marker, temp.X);
					SetViewportY(marker, temp.Y);
