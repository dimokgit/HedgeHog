...
namespace Microsoft.Research.DynamicDataDisplay.Charts.Markers
{
	public class MarkerChart : PlotterElement
	{
		...
		protected virtual void RebuildMarkers(bool shouldReleaseMarkers)
		{
			...
			IndependentArrangePanel specialPanel = itemsPanel as IndependentArrangePanel;
		...
		DependencyPropertyDescriptor descriptor = DependencyPropertyDescriptor.FromProperty(ViewportRectPanel.ActualViewportBoundsProperty, typeof(FrameworkElement));
		...
		private ViewportRectPanel itemsPanel = new ViewportRectPanel();
