...
namespace HedgeHog.Alice.Client {
  ...
  public partial class RemoteControlModel : RemoteControlModelBase {
    ...
    void charter_CorridorStartPositionChanged(object sender, CorridorPositionChangedEventArgs e) {
      ...
      var index = tm.RatesArray.IndexOf(new Rate() { StartDate = e.NewPosition });
    ...
    void ShowChart(TradingMacro tm) {
      try {
        ...
        var waveQuickRate = tm.WaveTradeStart == null || !tm.WaveTradeStart.HasRates ? null : tm.WaveTradeStart.Rates.OrderBy(r => r.StartDateContinuous).First();
