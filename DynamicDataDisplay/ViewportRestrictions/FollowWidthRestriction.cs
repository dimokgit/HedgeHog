...
namespace Microsoft.Research.DynamicDataDisplay.ViewportRestrictions
{
	...
	/// Probably is better to add to FitToView restrictions of <see cref="Viewport"/>.
	/// </summary>
	public class FollowWidthRestriction : ViewportRestriction
	{
		...
		public override DataRect Apply(DataRect previousDataRect, DataRect proposedDataRect, Viewport2D viewport)
		{
			...
			if (!viewport.ContentBounds.IsEmpty)
			{
				followWidth = Math.Min(width, viewport.ContentBounds.Width);
			}
