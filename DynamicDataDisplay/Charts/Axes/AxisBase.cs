...
namespace Microsoft.Research.DynamicDataDisplay.Charts
{
	...
	public abstract class AxisBase<T> : GeneralAxis, ITypedAxis<T>, IValueConversion<T>
	{
		...
		{
			get { return axisControl.MayorLabelProvider; }
			set { axisControl.MayorLabelProvider = value; }
		}
		...
		{
			get { return axisControl.DrawMayorLabels; }
			set { axisControl.DrawMayorLabels = value; }
		}
